...
-    Tools to **collect, store, and clean data** (e.g., databases, cloud storage, data pipelines)
    ...
    Examples: SQL, Apache Spark, pandas (for local data)
...
-    Especially for large models like neural networks
...
Machine learning is used **everywhere** now. Some broad categories:
